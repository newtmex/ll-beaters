...
export function parseBigNumber(value: string | undefined, decimals = 0): BigNumber {
...
export default function useParseBigNumber(value: string | undefined, decimals = 0): BigNumber {
